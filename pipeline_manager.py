...
def main():
    ...
    if args.phase == "phase1":
        ...
        if args.output_dir:
             ...
             Phase3Config.N_MIN_OCCURRENCES = 10
        ...
        from src.subspace_analysis import schemas
        from src.subspace_analysis.schemas import Phase3Config

        print("SCHEMAS FILE:", schemas.__file__)
        print("DIMENSIONS AT RUNTIME:", Phase3Config.DIMENSIONS)
        print("N_MIN_OCCURRENCES AT RUNTIME:", Phase3Config.N_MIN_OCCURRENCES)
        print("ANCHOR JSON AT RUNTIME:", Phase3Config.ANCHOR_DEF_JSON)
